...
RSpec.describe MeiliSearch::Index do
  it 'fetch the info of the index' do
    client.create_index('new_index', wait_for_completion: true)
  ...
  it 'get primary-key of index if null' do
    client.create_index('index_without_primary_key', wait_for_completion: true)
  ...
  it 'get primary-key of index if it exists' do
    client.create_index('index_with_prirmary_key', primaryKey: 'primary_key', wait_for_completion: true)
  ...
  it 'get uid of index' do
    client.create_index('uid', wait_for_completion: true)
  ...
  it 'updates primary-key of index if has been defined before but there is not docs' do
    client.create_index('uid', primaryKey: 'primary_key', wait_for_completion: true)
  ...
  it 'supports options' do
    ...
    new_client.create_index('options', wait_for_completion: true)
