...
- **Manipulate documents**: see the [API references](https://docs.meilisearch.com/reference/api/documents) or read more about [documents](https://docs.meilisearch.com/learn/core_concepts/documents).
- **Search**: see the [API references](https://docs.meilisearch.com/reference/api/search) or follow our guide on [search parameters](https://docs.meilisearch.com/reference/api/search#search-parameters).
- **Manage the indexes**: see the [API references](https://docs.meilisearch.com/reference/api/indexes) or read more about [indexes](https://docs.meilisearch.com/learn/core_concepts/indexes).
- **Configure the index settings**: see the [API references](https://docs.meilisearch.com/reference/api/settings) or follow our guide on [settings parameters](https://docs.meilisearch.com/reference/features/settings).
